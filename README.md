...
3 [Классы пользователей](#user_classes)  
...
Продукт должен являться мобильным приложением и иметь user-friendly оформление. 
...
2. Просмотр отделений банков на карте возможен при отключенной геолокации, при отключенной локации можно просмотреть все возможные адреса, включенная локация позволит просмотреть найти самые близкие отделения необходимого или любого банка.
...
3. Обновление информации о ценах(купля\продажа) происходит 8 раз в сутки( 00.00, 03.00, 06.00, 09.00, 12.00, 15.00, 18.00, 21.00) в фоновом режиме.

<a name="security_requirements"/>

#### 3.2.1.2 Требования к безопасности
Приложение не хранит личные данные пользователя, следовательно не нуждается в защите персональных данных.
Приложение необходима защитить от несанкционированного доступа к еще не загруженной в приложение информации о ценах, при котором в приложение могут быть внесены некорректные данные, что повлечет за собой недовольство и недоверие со стороны пользователей.
...
2.	Язык написания не регламентирован ( но необходимо выбрать не более одного языка написания, для упрощения последующей поддержки и обновления приложения).
