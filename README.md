...
# 1 Объектно-ориентированное	проектирование системы.                                   Язык	UML
...
Далее будут преставлены возможные ситуации, которые могут возникать при использовании приложения, как со стороны администратора, так и со стороны пользователя. 
